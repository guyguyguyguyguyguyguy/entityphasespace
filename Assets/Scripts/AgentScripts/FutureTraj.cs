    ...
    */
    ...
    public class CollisionModel
    {
        ...
        */
        ...
        public Dictionary<float[ , ], int> discreteModel = new Dictionary<float[ , ], int>(); 

        public CollisionModel(int nStepsForward, float agentSize)
        {
            nStepsForward = nStepsForward;
            GenerateModelGrid(agentSize);
        }

        private void GenerateModelGrid(float agentSize)
        {
        ...
        public void GenerateModelAbstraction(float[ ] stateOfModel)
        {
